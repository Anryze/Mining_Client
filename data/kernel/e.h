...
#define Z_BLOCK_HEADER_LEN		140
#define Z_BLOCK_OFFSET_NTIME        (4 + 3 * 32)
#define Z_NONCE_LEN			32
#define Z_SOLSIZE_LEN		3
#define Z_SOLSIZE_HEX               "fd4005"
#define Z_SOL_LEN                   ((1 << PARAM_K) * (PREFIX + 1) / 8)
#define N_ZERO_BYTES			12
#define Z_HASH_LEN                  50
#define BLAKE_WPS               	10
#define MAX_SOLS			11
